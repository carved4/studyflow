...
const GradePredictor = () => {
    ...
    const updateGradeItem = (id, field, value) => {
        setGradeItems(gradeItems.map((item) => item.id === id ? { ...item, [field]: Number(value) } : item));
    };
    ...
    return (_jsxs(Box, { sx: {
            ...
            minHeight: '100vh',
                    ...
                    px: { xs: 1, sm: 2, md: 3 },
                            ...
                            }, children: [_jsx(TableContainer, { children: _jsxs(Table, { children: [_jsx(TableHead, { children: _jsxs(TableRow, { children: [_jsx(TableCell, { children: "Assessment" }), _jsx(TableCell, { align: "right", children: "Weight (%)" }), _jsx(TableCell, { align: "right", children: "Score" }), _jsx(TableCell, { align: "right", children: "Max Score" }), _jsx(TableCell, { align: "right", children: "Actions" })] }) }), _jsx(TableBody, { children: gradeItems.map((item) => (_jsxs(TableRow, { children: [_jsx(TableCell, { children: _jsx(TextField, { fullWidth: true, size: "small", value: item.name, onChange: (e) => updateGradeItem(item.id, 'name', e.target.value), variant: "outlined" }) }), _jsx(TableCell, { align: "right", children: _jsx(TextField, { type: "number", size: "small", value: item.weight, onChange: (e) => updateGradeItem(item.id, 'weight', e.target.value), inputProps: { min: 0, max: 100 }, variant: "outlined" }) }), _jsx(TableCell, { align: "right", children: _jsx(TextField, { type: "number", size: "small", value: item.score, onChange: (e) => updateGradeItem(item.id, 'score', e.target.value), inputProps: { min: 0 }, variant: "outlined" }) }), _jsx(TableCell, { align: "right", children: _jsx(TextField, { type: "number", size: "small", value: item.maxScore, onChange: (e) => updateGradeItem(item.id, 'maxScore', e.target.value), inputProps: { min: 0 }, variant: "outlined" }) }), _jsx(TableCell, { align: "right", children: _jsx(IconButton, { color: "error", onClick: () => removeGradeItem(item.id), disabled: gradeItems.length === 1, children: _jsx(DeleteIcon, {}) }) })] }, item.id))) })] }) }), _jsx(Button, { startIcon: _jsx(AddIcon, {}), variant: "outlined", onClick: addGradeItem, sx: { mt: 2 }, color: "primary", children: "Add Assessment" })] }) }), _jsx(Grid, { item: true, xs: 12, md: 4, children: _jsxs(Stack, { spacing: 2, children: [_jsx(Card, { variant: "outlined", sx: {
                                        backgroundColor: muiTheme.palette.background.paper,
